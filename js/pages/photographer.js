...
function diplayPhotographerMedia(photographData, photographMedias) {
    photographMedias
        ...
        .forEach((formatedMedia) => {
            const photoToDisplay = new PhotographerTemplateFactory(
                formatedMedia,
                'photographerPage',
            );
...
function displayLikeTjm(photographData, photographMedias) {
    ...
    const photograph = new PhotographerPage(
        photographData,
        undefined,
        allLikes,
    );
    const likeToDisplay = new PhotographerTemplateFactory(
        photograph,
        'photographerPage',
    );
...
function lightBox(photographData, photographMedias) {
    ...
    const displayImgLightbox = (photographData, imgToDisplay) => {
        ...
        const lightBoxImg = document.querySelector(
            '.lightBox__contentCarrouselImg',
        );

        const photograph = new PhotographerPage(photographData, imgToDisplay);
        const lightBox = new PhotographerTemplateFactory(
            photograph,
            'photographerPage',
        );
    ...
    for (image of domImages) {
        ...
        imageLike.addEventListener('click', (e) => {
            ...
            if (!heart.classList.contains('heart--clicked')) {
                imageLike.querySelector('p').innerHTML =
                    parseInt(likeNumber) + 1;
                ...
                imageLike.querySelector('p').innerHTML =
                    parseInt(imageLike.querySelector('p').innerHTML) - 1;
                likedPhotos -= 1;
            }
            displayLikeTjm(photographData, photographMedias);
        });
